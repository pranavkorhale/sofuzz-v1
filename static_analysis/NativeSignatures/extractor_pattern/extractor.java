...
class extractor {
    public static void main(String[] args) {
		...
		System.out.println("INFO  - Loading "+ appPath + " app ...");
        File sourceFolder = new File(appPath);
		...
		try{
	        ...
	        String fileOutName = appPath + "signatures_pattern.txt";
	        ...
	        for (JavaClass cls: classes) {
	        	...
	        	for (JavaMethod met: cls.getMethods()) {
	        		...
	        		if (met.isNative()) {
						...
						if(cls.isInner()){
							sig = sig + "_" + cls.getDeclaringClass().getName();
							sig = sig + "$" + clsName;
						} else {
							sig = sig + "_" + clsName;
						}
