...
import aaa.bbb.ccc.path.analyses.TargetedPathTransformerSpIntra;
import soot.*;
import soot.jimple.*;
...
public class ExtraDataUseTransformerSpIntra extends TargetedPathTransformerSpIntra {
    ...
    public ExtraDataUseTransformerSpIntra(String apkFilePath) {
        super(apkFilePath);
    }
