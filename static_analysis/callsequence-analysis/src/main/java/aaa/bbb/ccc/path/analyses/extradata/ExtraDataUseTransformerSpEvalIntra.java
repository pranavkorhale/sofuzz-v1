...
public class ExtraDataUseTransformerSpEvalIntra extends TargetedPathTransformerSpEvalIntra {
    ...
    public ExtraDataUseTransformerSpEvalIntra(String apkFilePath, List jsons) {
        super(apkFilePath, jsons);
    }

    //Map<String,Integer> intentCatCounts = new LinkedHashMap<String,Integer>();

    public ExtraDataUseTransformerSpEvalIntra(String apkFilePath, List jsons, boolean accountEv) {
        super(apkFilePath, jsons);
