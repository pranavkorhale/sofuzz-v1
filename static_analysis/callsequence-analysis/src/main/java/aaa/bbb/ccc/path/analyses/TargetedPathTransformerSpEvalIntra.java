...
public class TargetedPathTransformerSpEvalIntra {
	...
	static Logger logger = LoggerFactory.getLogger(TargetedPathTransformerSpEvalIntra.class);
	...
	TargetedPathTransformerSpEvalIntra() {
	...
	public TargetedPathTransformerSpEvalIntra(String apkFilePath, List jsons) {
		this();
		G.reset();
		this.apkFilePath = apkFilePath;
		File apk = new File(apkFilePath);
		this.apkName = apk.getName();
	...
	public void main(String folderName) throws IOException {
		...
		try {
			...
			outputPerApk = new FileWriter("intents/"+this.apkName+".eval");
